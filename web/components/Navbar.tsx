  ...
  return (
    <nav className="flex justify-between items-center h-16 px-gutter w-full max-w-terminal mx-auto bg-background text-primary-fixed docked full-width top-0 border-b border-outline-hairline sticky z-40">
      ...
      <div className="flex items-center gap-md">
        ...
        {/* Mobile View Button - toggles mobile layout */}
        <button 
          onClick={toggleView}
          className="hidden @lg:flex items-center gap-2 px-3 py-2 border border-primary-fixed text-primary-fixed font-label-caps text-label-caps uppercase rounded-DEFAULT hover:bg-primary-fixed/10 transition-colors duration-200"
        >
